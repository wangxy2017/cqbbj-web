    ...
    --%>
        ...
        <div>
        <label><input type="checkbox" :value="menu.id" :key="menu.id" v-model="menu_ids" ><i>{{ menu.name }}</i></label>
        </div>
        <div>
        <label v-for="child in menu.childs">
        <input type="checkbox" :value="child.id" :key="menu.id" v-model="menu_ids"><i>{{ child.name }}</i>
        </label>
        </div>
        </li>
        </ul>
