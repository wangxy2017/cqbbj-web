...
<div class="main" id="main">
    ...
    <div class="search-tools">
        ...
        下单时间：
        <div class="layui-inline">
            <input class="layui-input" id="createTime1" name="createTime1" autocomplete="off" placeholder="YYYY-MM-DD"
                   v-model="createTime1">
        </div>
        至
        <div class="layui-inline">
            <input class="layui-input" id="createTime2" name="createTime2" autocomplete="off" placeholder="YYYY-MM-DD"
                   v-model="createTime2">
        </div>
