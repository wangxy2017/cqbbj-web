...
<div class="main" id="main" data-id="<%= request.getParameter("id")%>">
    <%-- 页面返回键 --%>
        <a class="layui-btn go-back" href="/car/car">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" name="insurance_date" required lay-verify="required" placeholder="YYYY-MM-DD"
               autocomplete="off"
               class="layui-input" v-model="car.insurance_date">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" name="examined_date" required lay-verify="required" placeholder="YYYY-MM-DD"
               autocomplete="off"
               class="layui-input" v-model="car.examined_date">
    </div>
</div>
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <input type="text" name="purchase_date" required lay-verify="required" placeholder="YYYY-MM-DD"
               autocomplete="off"
               class="layui-input"  v-model="car.purchase_date">
    </div>
</div>
