            ...
            <ul class="list-ul">
                <li class="row list-li" v-for="item in orders" @click="showBtns($event)">
                    ...
                    <div class="row li-title">
                        <div class="col-sm-7">
                            <p>订单号：<a href="javascript:;" @click.stop="view(item.id)"><span id="order_no">{{item.order_no}}</span></a>
                            </p>
                        </div>
                        <div class="col-sm-5">
                    ...
                    <div class="row display">
                        ...
                        <div class="col-sm-3">
                            <a class="assist">
                                <button type="button" @click.stop="finish(item.id,item.order_no)" class="btn btn-info">
                                    辅助
                                </button>
                            </a>
                        </div>
