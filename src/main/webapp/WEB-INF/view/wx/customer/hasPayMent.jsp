...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/wx/css/hasPayMent.css">
    <title>会员中心</title>
</head>
<body>
<header>
    ...
    <div class="col-sm-8" style="font-size: 6rem">
        <p>已付款</p>
    </div>
...
<div class="container-fluid" id="main">
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">重庆市渝高新城美好星空2栋206</div>
            <div class="col-sm-1">
        ...
        <div class="row">
            ...
            <div class="col-sm-8">重庆市合川区盐井镇荷花村六组21号</div>
            <div class="col-sm-1">
...
<script src="${pageContext.request.contextPath}/resources/wx/js/hasPayMent.js"></script>
</body>
</html>
